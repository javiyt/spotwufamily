...
func TestSyncCatalogProcessesEnabledArtistsAndDeduplicates(t *testing.T) {
	...
	repository := &fakeRepository{stats: catalogsync.SyncStats{AlbumsUpserted: 1, TracksUpserted: 1}}
...
func (f *fakeFetcher) GetArtist(context.Context, string) (catalog.ArtistCandidate, error) {
	if f.err != nil {
